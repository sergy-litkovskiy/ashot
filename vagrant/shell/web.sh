...
SOURCE_PATH=/var/www/ashot.kiev.loc
...
cp ${SOURCE_PATH}/bin/vagrant/configs/ashot.kiev.loc /etc/apache2/sites-available/ashot.kiev.loc.conf
ln -s /etc/apache2/sites-available/ashot.kiev.loc.conf /etc/apache2/sites-enabled/
...
echo "mysql-server mysql-server/root_password password clio2004" | debconf-set-selections
echo "mysql-server mysql-server/root_password_again password clio2004" | debconf-set-selections
