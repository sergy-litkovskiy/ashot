 ...
 * @author Litkovsky
 * @copyright 2010
 * model for object RESTAURANT
 */
if ( ! defined('BASEPATH')) exit('No direct script access allowed');


class Restaurant_model extends Crud
{
    ...
    /**
	 * get list of all imgages (if there is not status off) and description from category
	 */
	public function getListJoin()
	{
       ...
       $this -> db -> where($this->table.'.cat_name', 'restaurant');
