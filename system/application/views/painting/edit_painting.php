...
<form class="add_new" action='<?php echo base_url();?>painting/check_valid/update/<?php echo $part;?>' method='post' name='add_new' enctype='multipart/form-data'>
    ...
    <tr> 
        ...
        <td>
            <input style='border: 1px solid #C0C0C0;width:10%' name='sell_price' value="<?php echo set_value('sell_price',$result[0]['sell_price']);?>"/>&nbsp;$
        </td>
    </tr> 
    <tr>
        <td colspan="2">   
