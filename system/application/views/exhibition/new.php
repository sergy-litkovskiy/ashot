...
<form class="add_new" action='<?php echo base_url();?>exhibition/check_valid/add/<?php echo $part;?>' method='post' name='add_new' enctype='multipart/form-data'>
<div id="add_img_tmpl">
    ...
    <tr> 
        ...
        <td>
            <input style='border: 1px solid #C0C0C0;width:10%' name='sell_price[]' value="<?php echo set_value('sell_price[]');?>"/>&nbsp;$
        </td>
    </tr> 
    <tr>
        <td colspan="2">   
            <p><b>Материал:</b><input style='border: 1px solid #C0C0C0;width:20%' name='img_material[]' value="<?php echo set_value('img_material[]');?>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b>Размеры:</b>
                <input style='border: 1px solid #C0C0C0;width:5%' name='img_width[]' value="<?php echo set_value('img_width[]');?>"/>&nbsp;x&nbsp;
                <input style='border: 1px solid #C0C0C0;width:5%' name='img_height[]' value="<?php echo set_value('img_height[]');?>"/>&nbsp;см&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
